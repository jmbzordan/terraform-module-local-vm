...
resource "aws_instance" "instance" {
  ...
  subnet_id                       = module.vpc.subnet_id    # o ID da subnet configurado no outputs.tf daquele código
  vpc_security_group_ids          = [ module.vpc.security_group_id ]    # Referencia as IDs dos grupos criados no exercício anterior. 
